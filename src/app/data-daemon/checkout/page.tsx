  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex items-start gap-3 rounded-xl border border-emerald-400/20 bg-emerald-400/5 px-4 py-3 mb-10">
          <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-emerald-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
